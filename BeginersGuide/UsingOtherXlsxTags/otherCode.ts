...
const email = new cop.elements.EmailQRCode(
    ...
    'Respected Sir,/n I need some guidance regarding how to use cloudofficeprint sdk. /nThank You',//body
);
...
const sms = new cop.elements.SMSQRCode(
    ...
    'Respected Sir,/n I need some guidance regarding how to use cloudofficeprint sdk. /nThank You',//message to be sent
);
collection.add(sms);
...
const printjob = new cop.PrintJob(
    collection,
    server,
    cop.Resource.fromLocalFile('C:/Users/em8ee/cloudofficeprint-javascript/BeginersGuide/UsingOtherXlsxTags/data/otherBarcode_temp.xlsx'),
);
...
(async () => {
    try{
        ...
        await response.toFile('C:/Users/em8ee/cloudofficeprint-javascript/BeginersGuide/UsingOtherXlsxTags/output/otherBarcode_output.xlsx');
    }catch(err){
        console.log(err);
    }
})()