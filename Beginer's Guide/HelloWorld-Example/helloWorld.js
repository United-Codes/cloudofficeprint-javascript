...
var title = new cop.elements.Property("title", "Hello World!");
collection.add(title);
var PATH_TO_TEMPLATE_FILE = './data/template.docx';
var PATH_OF_OUTPUT_FILE = './output/output.docx';
// Create the text element and add it to the element collection
var text = new cop.elements.Property("text", "This is an example created with the Cloud Office Print TypeScript SDK");
collection.add(text);
// Add server
...
// Create print job
var printjob = new cop.PrintJob(collection, server, cop.Resource.fromLocalFile(PATH_TO_TEMPLATE_FILE));
// Asynchronously execute print job and save response to file
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var response;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, printjob.execute()];
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.toFile(PATH_OF_OUTPUT_FILE)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
