...
var testBarcode = new cop.elements.BarCode('barcodeName', '123456789125', 'ean13');
var barcode = new cop.elements.BarCode('barcodeWithMoreOptions', '9845632872578', 'ean13', 50, 70, 'L', 'https://www.cloudofficeprint.com/', 0, 'red', 25, 25, 'includetext guardwhitespace');
...
// Create print job
var printjob = new cop.PrintJob(collection, server, cop.Resource.fromLocalFile('./data/barCode_template.docx'));
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.toFile('./output/output_barCode')];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
