...
var line1 = new cop.elements.LineSeries(['a', 'b', 'c'], [1, 2, 3], 'line1', 'red', true, 'diamond', 10, '0.2cm', 'sysDashDotDot');
var line2 = new cop.elements.LineSeries(['a', 'b', 'c'], [4, 5, 6], 'line2', 'blue', true, 'square', 12, '2px', 'sysDash');
...
// );
//Name of tag name of lineChart should be same.
var lineChart = new cop.elements.LineChart('chart', [line1]);
...
// Create print job
var printjob = new cop.PrintJob(collection, server, cop.Resource.fromLocalFile('./data/template_lineChart.docx'));
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.toFile('./output/output_LineChart')];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
