...
var area1 = new cop.elements.AreaSeries(['a', 'b', 'c'], [1, 2, 3], 'area1', 'red', 50);
var area2 = new cop.elements.AreaSeries(['a', 'b', 'c'], [4, 5, 6], 'area2', 'blue', 80);
var areaChart = new cop.elements.AreaChart('area_chart', [area1, area2]);
...
// Create print job
var printjob = new cop.PrintJob(collection, server, cop.Resource.fromLocalFile('./data/template_areaChart.docx'));
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.toFile('./output/output_areaChart')];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
