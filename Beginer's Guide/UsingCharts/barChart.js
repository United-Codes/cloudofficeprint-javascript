...
var bars1 = new cop.elements.BarSeries(['a', 'b', 'c'], [1, 2, 3], 'bars1', 'red');
var bars2 = new cop.elements.BarSeries(['a', 'b', 'c'], [4, 5, 6], 'bars2', 'blue');
var barChart = new cop.elements.BarChart('bar_chart', [bars1, bars2]);
...
// Create print job
var printjob = new cop.PrintJob(collection, server, cop.Resource.fromLocalFile('./data/template_barChart.docx'));
var fs = require("fs");
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.toFile('./output/output_barChart')];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
