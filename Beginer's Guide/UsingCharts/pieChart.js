...
var pies1 = new cop.elements.PieSeries(['a', 'b', 'c'], [1, 2, 3], 'pies1', ['red', undefined, 'blue']);
var pies2 = new cop.elements.PieSeries(['a', 'b', 'c'], [4, 5, 6], 'pies2', ['green', 'blue', undefined]);
var piesChart = new cop.elements.PieChart('pie_chart', [pies1, pies2]);
...
// Create print job
var printjob = new cop.PrintJob(collection, server, cop.Resource.fromLocalFile('./data/template_pieChart.docx'));
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.toFile('./output/output_pieChart')];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
