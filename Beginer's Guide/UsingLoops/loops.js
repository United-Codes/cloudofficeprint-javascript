...
//------------------
var element1 = cop.elements.ElementCollection.fromMapping({
    a: 1,
    b: 2,
    c: 3
});
var element2 = cop.elements.ElementCollection.fromMapping({
    a: 4,
    b: 5,
    c: 6
});
var loop = new cop.elements.ForEach('loop_name', [element1, element2]);
collection.add(loop);
// Add server
...
// Create print job
var printjob = new cop.PrintJob(collection, server, cop.Resource.fromLocalFile('./data/loop_template.docx'));
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                return [4 /*yield*/, response.toFile('./output/output')];
            case 2:
                _a.sent();
                return [3 /*break*/, 4];
            case 3:
